...
public class UsersServiceImpl implements UsersService {
    ...
    public OtherPlayerProfileResponse getOtherPlayerProfile(String papayaUserId) {
        ...
        if (wife == null) {
            wife = new Housewife("123", "Paula", 345000, Housewife.Type.Modern, new Integer[] {
                    85, 79, 66 }, 2, 3);
        }
...
//        House house = (House) wifeDao.get("house-" + papayaUserId);
    ...
    public Housewife findBestHousewife() {
        ...
        Housewife wife = (Housewife) wifeDao.get(papayaUserId + "-wife");
        if (wife == null) {
            wife = new Housewife("12323", "Michi", 3000, Housewife.Type.Modern, new Integer[] { 85, 79,
                    66 }, 2, 3);
        }
        return wife;
    }
    ...
    public Reward getDailyBonus(String papayaUserId) {
        DailyBonus dailyBonus = (DailyBonus) wifeDao.get("daily-" + papayaUserId);
        Reward reward = null;
        if (dailyBonus == null) {
